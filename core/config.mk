...
ifneq ($(CLOVER_BUILD),)
include vendor/clover/config/BoardConfigClover.mk
endif
...
ifneq ($(CLOVER_BUILD),)
ifneq ($(wildcard device/clover/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/clover/sepolicy/common/sepolicy.mk)
endif
endif
...
else ifneq ($(filter vendor/clover-priv/%,$(DEFAULT_SYSTEM_DEV_CERTIFICATE)),)
